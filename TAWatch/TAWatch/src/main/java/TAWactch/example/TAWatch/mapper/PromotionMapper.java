...
public interface PromotionMapper {
    ...
    @Mapping(target = "watchSlugs", expression = "java(promotion.getWatches() == null ? java.util.List.of() : promotion.getWatches().stream().map(w -> w.getSlug()).collect(java.util.stream.Collectors.toList()))")
