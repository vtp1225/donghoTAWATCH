...
import TAWactch.example.TAWatch.order.service.GhnService;
...
public class GhnController {
    ...
    public ApiResponse<List<Map<String, Object>>> getDistricts(@RequestParam Integer provinceId) {
        ApiResponse<List<Map<String, Object>>> res = new ApiResponse<>();
        res.setCode(200);
        res.setMessage("Success");
    ...
    @GetMapping("/wards")
    public ApiResponse<List<Map<String, Object>>> getWards(@RequestParam Integer districtId) {
        ApiResponse<List<Map<String, Object>>> res = new ApiResponse<>();
        res.setCode(200);
        res.setMessage("Success");
    ...
    @PostMapping("/fee")
    public ApiResponse<Map<String, Object>> calculateFee(@RequestBody Map<String, Object> body) {
    ...
    // GET /ghn/tracking?orderCode=xxx
    @GetMapping("/tracking")
    public ApiResponse<Map<String, Object>> getTracking(@RequestParam String orderCode) {
        ApiResponse<Map<String, Object>> res = new ApiResponse<>();
        Map<String, Object> data = ghnService.getOrderTracking(orderCode);
        if (data != null) {
            res.setCode(200);
            res.setMessage("Success");
            res.setData(data);
            ...
            res.setCode(404);
            res.setMessage("Tracking code not found or error");
            res.setData(null);
        }
        return res;
    }
