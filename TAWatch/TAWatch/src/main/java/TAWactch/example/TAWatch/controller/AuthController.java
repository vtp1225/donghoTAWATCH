...
import TAWactch.example.TAWatch.dto.request.GoogleLoginRequest;
...
public class AuthController {
    ...
    @PostMapping("/google")
    public ApiRespone<AuthResponse> loginWithGoogle(@Valid @RequestBody GoogleLoginRequest request) {
        ApiRespone<AuthResponse> response = new ApiRespone<>();
        response.setCode(200);
