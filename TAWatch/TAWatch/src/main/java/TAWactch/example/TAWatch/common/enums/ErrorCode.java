...
public enum ErrorCode {
    ...
    COUPON_NOT_APPLICABLE_FOR_THESE_ITEMS(5014, "Mã giảm giá không áp dụng cho các sản phẩm trong giỏ hàng"),
    RETURN_PERIOD_EXPIRED(5013, "Đã quá hạn 7 ngày để yêu cầu đổi/trả"),
    ...
    PROMOTION_INACTIVE(9007, "Chương trình khuyến mãi đang tắt, không thể tạo coupon"),
    PROMOTION_EXPIRED(9008, "Chương trình khuyến mãi đã kết thúc, không thể tạo coupon"),
    PROMOTION_NOT_STARTED(9009, "Chương trình khuyến mãi chưa bắt đầu, không thể tạo coupon"),
    PROMOTION_EXHAUSTED(9010, "Chương trình khuyến mãi đã hết lượt sử dụng"),
    // Slug
