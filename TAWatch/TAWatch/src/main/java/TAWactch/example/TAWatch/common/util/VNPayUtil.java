package TAWactch.example.TAWatch.common.util;
...
public class VNPayUtil {
    ...
    public static boolean verifySignature(Map<String, String> params, String hashSecret) {
        ...
        // VNPay computes hash on URL-encoded values; Spring decodes params before delivery,
        // so we must re-encode to match what VNPay originally signed.
        String hashString = buildQueryString(filteredParams);
        String computedHash = hmacSHA512(hashSecret, hashString);
