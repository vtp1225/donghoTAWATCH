    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Loyalty — user tự xem hạng của mình
                        .requestMatchers(HttpMethod.GET, "/users/*/loyalty").authenticated()
                        ...
                        // Payment APIs
                        .requestMatchers(HttpMethod.GET, "/payments/order/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/payments/*/confirm").hasRole("ADMIN")
                        ...
                        // Shipper APIs
                        .requestMatchers(HttpMethod.GET, "/shippers/**").hasRole("ADMIN")
                        ...
                        // Import Receipt APIs
                        .requestMatchers(HttpMethod.GET, "/import-receipts/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/import-receipts").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/import-receipts/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/import-receipts/**").hasRole("ADMIN")

                        // Store Settings APIs - public read, admin write
