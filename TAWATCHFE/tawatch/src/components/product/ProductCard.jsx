...
export default function ProductCard({ item, offsetClassName = '' }) {
  ...
  return (
    <div className={`group product-card-hover relative cursor-pointer ${offsetClassName}`}>
      <div className="relative mb-6 flex aspect-square items-center justify-center overflow-hidden bg-surface-container p-8">
      ...
      <div className="space-y-2 px-2">
        ...
        <div className="pt-4 flex items-center gap-3">
          ...
          {/* Discover link */}
          <span className="flex-shrink-0 border-b border-primary/40 pb-0.5 font-label-caps text-[10px] tracking-[0.14em] text-primary transition-opacity duration-300 opacity-0 group-hover:opacity-100">
            {item.ctaLabel || 'Chi tiết →'}
          </span>
        </div>
      </div>
    </div>
